 ...
 * @author Martono
 */
public class LaporanStokBarang extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        JLLaporanStokBarang = new KomponenGUI.JlableF();
        JLTanggalStok = new KomponenGUI.JlableF();
        JLTanggalStok2 = new KomponenGUI.JlableF();
        JDTanggalStokAwal = new KomponenGUI.JdateCF();
        JLTanggalStok3 = new KomponenGUI.JlableF();
        JDTanggalStokAkhir = new KomponenGUI.JdateCF();
        ...
        JLLaporanStokBarang.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        JLLaporanStokBarang.setText("LAPORAN STOK BARANG");

        JLTanggalStok.setText("Tanggal Stok");

        JLTanggalStok2.setText(":");

        JDTanggalStokAwal.setDate(new Date());
        JDTanggalStokAwal.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                JDTanggalStokAwalKeyReleased(evt);
            }
        });

        JLTanggalStok3.setText("s/d");

        JDTanggalStokAkhir.setDate(new Date());
        JDTanggalStokAkhir.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                JDTanggalStokAkhirKeyReleased(evt);
            }
        });
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(JLLaporanStokBarang, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addGroup(layout.createSequentialGroup()
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addComponent(JLTanggalStok, javax.swing.GroupLayout.PREFERRED_SIZE, 126, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(JLTanggalStok2, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(JDTanggalStokAwal, javax.swing.GroupLayout.PREFERRED_SIZE, 150, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(JLTanggalStok3, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(JDTanggalStokAkhir, javax.swing.GroupLayout.PREFERRED_SIZE, 150, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(JLLaporanStokBarang, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                        .addComponent(JLTanggalStok, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addComponent(JLTanggalStok2, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addComponent(JDTanggalStokAwal, javax.swing.GroupLayout.PREFERRED_SIZE, 28, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(JDTanggalStokAkhir, javax.swing.GroupLayout.PREFERRED_SIZE, 28, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(JLTanggalStok3, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
    ...
    private void formWindowClosed(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowClosed
        GlobalVar.Var.laporanStokBarang = null;
    ...
    private void JDTanggalStokAwalKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_JDTanggalStokAwalKeyReleased
        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
            JDTanggalStokAkhir.requestFocus();
        }
    }//GEN-LAST:event_JDTanggalStokAwalKeyReleased

    private void JDTanggalStokAkhirKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_JDTanggalStokAkhirKeyReleased
        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
            JCJenisBarang.requestFocus();
        }
    }//GEN-LAST:event_JDTanggalStokAkhirKeyReleased
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new LaporanStokBarang();
            }
        });
    }

    boolean checkInput() {
        if (JDTanggalStokAwal.getDate() == null) {
            JOptionPane.showMessageDialog(this, "Tanggal Stok Awal Tidak Boleh Kosong", "Information", JOptionPane.INFORMATION_MESSAGE);
            JDTanggalStokAwal.requestFocus();
            return false;
        } else if (JDTanggalStokAkhir.getDate() == null) {
            JOptionPane.showMessageDialog(this, "Tanggal Stok Akhir Tidak Boleh Kosong", "Information", JOptionPane.INFORMATION_MESSAGE);
            JDTanggalStokAkhir.requestFocus();
            return false;
        } else if (JDTanggalStokAkhir.getDate().compareTo(JDTanggalStokAwal.getDate()) < 0) {
            JOptionPane.showMessageDialog(this, "Tanggal Stok Akhir Tidak Boleh Lebih Kecil Dari Tanggal Stok Awal", "Information", JOptionPane.INFORMATION_MESSAGE);
            JDTanggalStokAkhir.requestFocus();
            return false;
        } else {
            return true;
    ...
    void tampilkan() {
        if (checkInput()) {
            ...
            hashs.put("Title", "Laporan Stok Barang");
            hashs.put("TanggalStokAwal", FDateF.datetostr(JDTanggalStokAwal.getDate(), "yyyy-MM-dd"));
            hashs.put("TanggalStokAkhir", FDateF.datetostr(JDTanggalStokAkhir.getDate(), "yyyy-MM-dd"));
            hashs.put("FormatTanggalStokAwal", FDateF.datetostr(JDTanggalStokAwal.getDate(), "dd/MM/yyyy"));
            hashs.put("FormatTanggalStokAkhir", FDateF.datetostr(JDTanggalStokAkhir.getDate(), "dd/MM/yyyy"));
            if (JCJenisBarang.getSelectedIndex() == 0) {
                jenisBarang = "";
...
>>>>>>> fd6b13465d1c9684886568239793c3eb687e93d3
            fLaporan.sethashmap(hashs);
            fLaporan.setfilename("LaporanStokBarang");
            fLaporan.setErorm("Gagal Menampilkan " + this.getTitle());
            fLaporan.excute();
            History.simpanhistory(GlobalVar.VarL.username, "Melihat Laporan Stok Barang");
        }
    }
    ...
    private KomponenGUI.JdateCF JDTanggalStokAkhir;
    private KomponenGUI.JdateCF JDTanggalStokAwal;
    ...
    private KomponenGUI.JlableF JLLaporanStokBarang;
    private KomponenGUI.JlableF JLNamaBarang;
    private KomponenGUI.JlableF JLNamaBarang2;
    private KomponenGUI.JlableF JLTanggalStok;
    private KomponenGUI.JlableF JLTanggalStok2;
    private KomponenGUI.JlableF JLTanggalStok3;
