...
import Master.MasterJenisService;

/**
 *
 * @author Martono
 */
public class ListMasterJenisService extends javax.swing.JFrame {

    /**
     * Creates new form NewJFrame
     */
    public ListMasterJenisService() {
        initComponents();
        setLocationRelativeTo(null);
        setDefaultCloseOperation(DISPOSE_ON_CLOSE);
        setTitle("Master Jenis Service");
        setVisible(true);
        load();
    ...
    private void JBKembaliActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_JBKembaliActionPerformed
        GlobalVar.Var.listMasterJenisService.dispose();
    ...
    private void formWindowClosed(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowClosed
        GlobalVar.Var.listMasterJenisService = null;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ListMasterJenisService.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ListMasterJenisService();
            }
        });
    }

    public void load() {
        JComCari.setQuery("SELECT `IdJenisService` AS 'ID', `JenisService` AS 'Jenis Service', `Keterangan` FROM `tbmjenisservice`");
        JComCari.tampilkan();
    }
    ...
    void ubah() {
        if (JComCari.getSelectedRow() < 0) {
            ...
            if (GlobalVar.Var.editMasterJenisService == null) {
                GlobalVar.Var.editMasterJenisService = new MasterJenisService(JComCari.GetIDTable());
            } else {
                GlobalVar.Var.editMasterJenisService.setState(NORMAL);
                GlobalVar.Var.editMasterJenisService.toFront();
            }
        }
    }
    ...
    void hapus() {
        if (JComCari.getSelectedRow() < 0) {
            ...
            if (delete.Hapus(JComCari.GetIDTable(), "DELETE FROM `tbmjenisservice` WHERE `IdJenisService`=" + JComCari.GetIDTable(), "Hapus Data Master Jenis Service", this)) {
                load();
            }
        }
    }
