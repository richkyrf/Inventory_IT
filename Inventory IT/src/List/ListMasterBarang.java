 ...
 * @author Martono
 */
public class ListMasterBarang extends javax.swing.JFrame {

    /**
     * Creates new form NewJFrame
     */
    public ListMasterBarang() {
        initComponents();
    ...
    private void JBKembaliActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_JBKembaliActionPerformed
        GlobalVar.Var.listMasterBarang.dispose();
    ...
    private void formWindowClosed(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowClosed
        GlobalVar.Var.listMasterBarang = null;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ListMasterBarang.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ListMasterBarang();
            }
        });
    }

    public void load() {
        JComCari.setQuery("SELECT `IdBarang` AS 'ID', `JenisBarang` AS 'Jenis Barang', `KategoriBarang` AS 'Kategori Barang', `NamaBarang` AS 'Nama Barang', `Garansi`, A.`Keterangan` FROM `tbmbarang` AS A JOIN `tbmkategoribarang` AS B ON A.`IdKategoriBarang`=B.`IdKategoriBarang` JOIN `tbmjenisbarang` AS C ON B.`IdJenisBarang`=C.`IdJenisBarang`");
    ...
    void ubah() {
        if (JComCari.getSelectedRow() < 0) {
            ...
            if (GlobalVar.Var.editMasterBarang == null) {
                GlobalVar.Var.editMasterBarang = new MasterBarang(JComCari.GetIDTable());
            } else {
                GlobalVar.Var.editMasterBarang.setState(NORMAL);
                GlobalVar.Var.editMasterBarang.toFront();
            }
        }
    }
    ...
    void hapus() {
        if (JComCari.getSelectedRow() < 0) {
            ...
            if (delete.Hapus(JComCari.GetIDTable(), "DELETE FROM `tbmbarang` WHERE `IdBarang`=" + JComCari.GetIDTable(), "Hapus Data Master Barang", this)) {
                load();
            }
        }
    }
