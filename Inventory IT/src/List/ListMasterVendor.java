 ...
 * @author Martono
 */
public class ListMasterVendor extends javax.swing.JFrame {

    /**
     * Creates new form NewJFrame
     */
    public ListMasterVendor() {
        initComponents();
        setLocationRelativeTo(null);
        setDefaultCloseOperation(DISPOSE_ON_CLOSE);
        setTitle("Master Vendor");
        setVisible(true);
        load();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ListMasterVendor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ListMasterVendor();
            }
        });
    }

    public void load() {
        JComCari.setQuery("SELECT `IdVendor` AS 'ID', `NamaVendor` AS 'Nama Vendor', `NomorTelepon` AS 'Nomor Telepon', `Alamat`, `Keterangan` FROM `tbmvendor`");
        JComCari.tampilkan();
    }
    ...
    void hapus() {
        if (JComCari.getSelectedRow() < 0) {
            ...
            if (delete.Hapus(JComCari.GetIDTable(), "DELETE FROM `tbmvendor` WHERE `IdVendor`=" + JComCari.GetIDTable(), "Hapus Data Master Vendor", this)) {
                load();
            }
        }
    }
