...
import Proses.BarangRusak;

/**
 *
 * @author Martono
 */
public class ListBarangRusak extends javax.swing.JFrame {

    /**
     * Creates new form NewJFrame
     */
    public ListBarangRusak() {
        initComponents();
        setLocationRelativeTo(null);
        setDefaultCloseOperation(DISPOSE_ON_CLOSE);
        setTitle("Barang Rusak");
        setVisible(true);
        load();
    ...
    private void JBKembaliActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_JBKembaliActionPerformed
        GlobalVar.Var.listBarangRusak.dispose();
    ...
    private void formWindowClosed(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowClosed
        GlobalVar.Var.listBarangRusak = null;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ListBarangRusak.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    void ubah() {
        if (JComCari.getSelectedRow() < 0) {
            ...
            if (GlobalVar.Var.editBarangRusak == null) {
                GlobalVar.Var.editBarangRusak = new BarangRusak(JComCari.GetIDTable());
            } else {
                GlobalVar.Var.editBarangRusak.setState(NORMAL);
                GlobalVar.Var.editBarangRusak.toFront();
            }
        }
    }
    ...
    void hapus() {
        if (JComCari.getSelectedRow() < 0) {
            ...
            if (delete.Hapus(JComCari.GetIDTable(), "DELETE FROM `tbbarangrusak` WHERE `IdBarangRusak`=" + JComCari.GetIDTable(), "Hapus Data Barang Rusak", this)) {
                load();
            }
        }
    }
