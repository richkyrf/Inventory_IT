...
import Master.MasterBarangService;

/**
 *
 * @author Martono
 */
public class ListMasterBarangService extends javax.swing.JFrame {

    /**
     * Creates new form NewJFrame
     */
    public ListMasterBarangService() {
        initComponents();
        setLocationRelativeTo(null);
        setDefaultCloseOperation(DISPOSE_ON_CLOSE);
        setTitle("Master Barang Service");
        setVisible(true);
        load();
    ...
    private void JBKembaliActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_JBKembaliActionPerformed
        GlobalVar.Var.listMasterBarangService.dispose();
    ...
    private void formWindowClosed(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowClosed
        GlobalVar.Var.listMasterBarangService = null;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ListMasterBarangService.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ListMasterBarangService();
            }
        });
    }

    public void load() {
        JComCari.setQuery("SELECT `IdBarangService` AS 'ID', `JenisBarangService` AS 'Jenis Barang Service', `NamaBarangService` AS 'Nama Barang Service', A.`Keterangan` FROM `tbmbarangservice` AS A JOIN `tbmjenisbarangservice` AS B ON A.`IdJenisBarangService`=B.`IdJenisBarangService`");
        JComCari.setSelectedIndex(2);
        JComCari.tampilkan();
    }
    ...
    void ubah() {
        if (JComCari.getSelectedRow() < 0) {
            ...
            if (GlobalVar.Var.editMasterBarangService == null) {
                GlobalVar.Var.editMasterBarangService = new MasterBarangService(JComCari.GetIDTable());
            } else {
                GlobalVar.Var.editMasterBarangService.setState(NORMAL);
                GlobalVar.Var.editMasterBarangService.toFront();
            }
        }
    }
    ...
    void hapus() {
        if (JComCari.getSelectedRow() < 0) {
            ...
            if (delete.Hapus(JComCari.GetIDTable(), "DELETE FROM `tbmbarangservice` WHERE `IdBarangService`=" + JComCari.GetIDTable(), "Hapus Data Master Barang Service", this)) {
                load();
            }
        }
    }
