 ...
 * @author Martono
 */
public class ListMasterKaryawan extends javax.swing.JFrame {

    /**
     * Creates new form NewJFrame
     */
    public ListMasterKaryawan() {
        initComponents();
        setLocationRelativeTo(null);
        setDefaultCloseOperation(DISPOSE_ON_CLOSE);
        setTitle("Master Karyawan (Pemakai)");
        setVisible(true);
        load();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ListMasterKaryawan.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ListMasterKaryawan();
            }
        });
    }

    public void load() {
        JComCari.setQuery("SELECT `IdKaryawan` AS 'ID', `NIK`, `NamaKaryawan` AS 'Nama Karyawan', `Keterangan` FROM `tbmkaryawan`");
    ...
    void hapus() {
        if (JComCari.getSelectedRow() < 0) {
            ...
            if (delete.Hapus(JComCari.GetIDTable(), "DELETE FROM `tbmkaryawan` WHERE `IdKaryawan`=" + JComCari.GetIDTable(), "Hapus Data Master Karyawan (Pemakai)", this)) {
                load();
            }
        }
    }
