...
public class ListBarangMasuk extends javax.swing.JFrame {
    ...
    public void load() {
        JComCari.setQuery("SELECT `IdBarangMasuk` as 'ID', `NomorBarangMasuk` as 'Nomor Barang Masuk', DATE_FORMAT(`TanggalBarangMasuk`, '%d/%m/%Y') as 'Tanggal Barang Masuk', `NomorPurchaseRequest` as 'Nomor Purchase Request', `NamaVendor` as 'Nama Vendor', a.`Keterangan` FROM `tbbarangmasuk`a JOIN `tbmvendor`b ON a.`IdVendor`=b.`IdVendor` ");
