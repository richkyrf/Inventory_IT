...
import Master.MasterKategoriBarang;

/**
 *
 * @author Martono
 */
public class ListMasterKategoriBarang extends javax.swing.JFrame {

    /**
     * Creates new form NewJFrame
     */
    public ListMasterKategoriBarang() {
        initComponents();
        setLocationRelativeTo(null);
        setDefaultCloseOperation(DISPOSE_ON_CLOSE);
        setTitle("Master Kategori Barang");
        setVisible(true);
        load();
    ...
    private void JBKembaliActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_JBKembaliActionPerformed
        GlobalVar.Var.listMasterKategoriBarang.dispose();
    ...
    private void formWindowClosed(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowClosed
        GlobalVar.Var.listMasterKategoriBarang = null;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ListMasterKategoriBarang.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ListMasterKategoriBarang();
            }
        });
    }

    public void load() {
        JComCari.setQuery("SELECT `IdKategoriBarang` AS 'ID', `JenisBarang` AS 'Jenis Barang', `KategoriBarang` AS 'Kategori Barang', A.`Keterangan` FROM `tbmkategoribarang` AS A JOIN `tbmjenisbarang` AS B ON A.`IdJenisBarang`=B.`IdJenisBarang`");
    ...
    void ubah() {
        if (JComCari.getSelectedRow() < 0) {
            ...
            if (GlobalVar.Var.editMasterKategoriBarang == null) {
                GlobalVar.Var.editMasterKategoriBarang = new MasterKategoriBarang(JComCari.GetIDTable());
            } else {
                GlobalVar.Var.editMasterKategoriBarang.setState(NORMAL);
                GlobalVar.Var.editMasterKategoriBarang.toFront();
            }
        }
    }
    ...
    void hapus() {
        if (JComCari.getSelectedRow() < 0) {
            ...
            if (delete.Hapus(JComCari.GetIDTable(), "DELETE FROM `tbmkategoribarang` WHERE `IdKategoriBarang`=" + JComCari.GetIDTable(), "Hapus Data Master Kategori Barang", this)) {
                load();
            }
        }
    }
