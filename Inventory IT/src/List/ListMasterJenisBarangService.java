...
import Master.MasterJenisBarangService;

/**
 *
 * @author Martono
 */
public class ListMasterJenisBarangService extends javax.swing.JFrame {

    /**
     * Creates new form NewJFrame
     */
    public ListMasterJenisBarangService() {
        initComponents();
        setLocationRelativeTo(null);
        setDefaultCloseOperation(DISPOSE_ON_CLOSE);
        setTitle("Master Jenis Barang Service");
        setVisible(true);
        load();
    ...
    private void JBKembaliActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_JBKembaliActionPerformed
        GlobalVar.Var.listMasterJenisBarangService.dispose();
    ...
    private void formWindowClosed(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowClosed
        GlobalVar.Var.listMasterJenisBarangService = null;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ListMasterJenisBarangService.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ListMasterJenisBarangService();
            }
        });
    }

    public void load() {
        JComCari.setQuery("SELECT `IdJenisBarangService` AS 'ID', `JenisBarangService` AS 'Jenis Barang Service', `Keterangan` FROM `tbmjenisbarangservice`");
        JComCari.tampilkan();
    }
    ...
    void ubah() {
        if (JComCari.getSelectedRow() < 0) {
            ...
            if (GlobalVar.Var.editMasterJenisBarangService == null) {
                GlobalVar.Var.editMasterJenisBarangService = new MasterJenisBarangService(JComCari.GetIDTable());
            } else {
                GlobalVar.Var.editMasterJenisBarangService.setState(NORMAL);
                GlobalVar.Var.editMasterJenisBarangService.toFront();
            }
        }
    }
    ...
    void hapus() {
        if (JComCari.getSelectedRow() < 0) {
            ...
            if (delete.Hapus(JComCari.GetIDTable(), "DELETE FROM `tbmjenisbarangservice` WHERE `IdJenisBarangService`=" + JComCari.GetIDTable(), "Hapus Data Master Jenis Barang Service", this)) {
                load();
            }
        }
    }
